...
var Calendar = __webpack_require__(179);
if ($("#calendar")[0]) {
...
function CalendarObject(settings) {
    ...
    // Get Events
    api.getData('calendar/events').then(function (valid) {
        self.events = valid;
        self.init();
        self.renderMonth();
    }, function (error) {
...
CalendarObject.prototype.changeMonth = function (direction) {
    ...
    this.eventsSync().then(function (data) {
        self.events = data;
        self.renderMonth();
    }, function (error) {
        console.log("Error fetching calendar data.");
...
var InvalidMonthError = __webpack_require__(10);
var InvalidMonthsError = __webpack_require__(11);
var InvalidMonthsAbbrError = __webpack_require__(12);

var InvalidWeekdayError = __webpack_require__(13);
var InvalidWeekdaysError = __webpack_require__(14);
var InvalidWeekdaysAbbrError = __webpack_require__(15);
